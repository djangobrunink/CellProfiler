...
Item = NamedTuple("Item", [('class_counts', Dict[str, int]), ('annotation_path', Path), ("image_path", Path)])
...
def main():
    class_names = ["Healthy", "Deformed", "Death"]
    data = []
    total = []
    ...
    for annotation_path in glob.glob("./**/*.json"):
        ...
        with open(annotation_path) as f:
            ...
            data.append(Item(class_counts=class_counts, annotation_path=annotation_path, image_path=image_path))
